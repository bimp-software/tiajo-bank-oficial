...
export default function Reporting({ t, lang }: WithTAndLang) {
    return (
        <article className="comunicaciones-reporting">
            ...
            <ul>
                ...
                <li>
                    <span><i className="bi bi-building-fill-check" /></span>
                    <div>
                        <strong>{t("reporting.items.institution.title")}</strong>
                        <p>{t("reporting.items.institution.text")}</p>
                    </div>
                </li>
