...
import Moneda from "../assets/img/comunidad.webp";
import Proteger from "../assets/img/proteger.webp";
import Facil from "../assets/img/facil de usar.webp";

import ImgFeatures from "../assets/img/funcionalidades-hero.webp";

export default function FuncionalidadesHero({ t, lang }:WithTAndLang) {
