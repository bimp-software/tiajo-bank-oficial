...
export default function Reporting({ t, lang }: WithTAndLang) {
    return (
        <article className="propiedad-intelectual-reporting">
            ...
            <ul>
                <li>
                    <span><i className="bi bi-flag-fill" /></span>
                    <div>
                        <strong>{t("reporting.items.notice.title")}</strong>
                        <p>{t("reporting.items.notice.text")}</p>
                    </div>
                </li>
                <li>
                    <span><i className="bi bi-file-earmark-text-fill" /></span>
                    <div>
                        <strong>{t("reporting.items.evidence.title")}</strong>
                        <p>{t("reporting.items.evidence.text")}</p>
                    </div>
                </li>
                <li>
